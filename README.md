<div align= "center">
    <img src="https://capsule-render.vercel.app/api?type=waving&color=8f8a8e&height=120&text=Eznnni's%20Github&animation=&fontColor=f8d8f1&fontSize=60" />
    </div>
    <div style="text-align: left;"> 
    <h2 style="border-bottom: 1px solid #21262d; color: #c9d1d9;"> 안녕하세요😊! </h2>  
    <div style="font-weight: 700; font-size: 15px; text-align: left; color: #c9d1d9;"> <div> &nbsp프론트엔드 개발자를 희망합니다.</div><div> &nbsp성장하는 사람이 되고 싶어요🍀 </div> 
    </div>
    <div style="text-align: left;">
